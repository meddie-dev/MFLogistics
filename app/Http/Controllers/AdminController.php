...
class AdminController extends Controller
{
    ...
    {
        // Magsimula ng isang array para sa mga buwan at bilang ng users
        $months = [];
        $userCounts = [];
        $roles = ['admin', 'supplier', 'constructor'];
        $roleCounts = [];

        // Magsimula sa nakaraang taon at bumalik sa kasalukuyang buwan
        ...
        // Magsimula sa bawat role at kuhanin ang bilang ng users
